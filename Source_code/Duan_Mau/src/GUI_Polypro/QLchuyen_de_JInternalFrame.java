 ...
 */
public class QLchuyen_de_JInternalFrame extends javax.swing.JInternalFrame {
     ...
     */
    public QLchuyen_de_JInternalFrame() {
        initComponents();
        this.CDDao = new chuyenDeDao();
        this.fileChooser = new JFileChooser("E:\\Downloads\\Du_an_mau\\Source_code\\Duan_Mau\\src\\icon");//hoặc JFileChooser c = new JFileChooser(String duongDan); //đường dẫn đến folder mở mặc định
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tabs, javax.swing.GroupLayout.DEFAULT_SIZE, 443, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );
    ...
    private boolean checkTrungMa(JTextField txt) {
        ...
        if (this.CDDao.findById(txt.getText()) == null) {
            return true;
        } else {
    ...
    */
    ...
    private void edit() {
        try {
            ...
            chuyenDe model = this.CDDao.findById(macd);
            if (model != null) {
                this.setModel(model);
    ...
    đọc file trong thư mục logos và hiển thị lên form, đặt tenFile là toolTipText của lblhinhanh
    ----------------------------------------------------------------------------
    ...
    private void selectImage() {
        if (fileChooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) { //nếu người dùng đã chọn đc file
            ...
            if (shareHelper.saveLogo(file)) {  //sao chép file đã chọn thư mục logos
                ...
                //void setIcon(ImageIcon icon) set Icon cho lblhinhanh
